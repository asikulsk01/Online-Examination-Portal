...
public class QuestionsDao {
	...
	public static boolean insertQuestion(Questions q) {
		...
		pst.setString(2, q.getSubjectCode());
	    pst.setString(3, q.getQuestion().trim());
	    pst.setString(4, q.getA());
	    pst.setString(5, q.getB());
	    pst.setString(6, q.getC());
	    pst.setString(7, q.getD());
	    pst.setString(8, q.getAnswer());
	...
	public static ArrayList<Questions> getAllRecords()
	{
		...
		try
		{
		   ...
		   while(rs.next())
		   {
			  ...
			  s.setQuestionId(rs.getString(1));
			  s.setSubjectCode(rs.getString(2));
			  s.setQuestion(rs.getString(3));
			  s.setAnswer(rs.getString(8));
			  s.setA(rs.getString(4));
			  s.setB(rs.getString(5));
			  s.setC(rs.getString(6));
			  s.setD(rs.getString(7));
			   samp.add(s);
