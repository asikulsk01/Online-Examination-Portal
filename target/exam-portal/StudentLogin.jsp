...
<style type="text/css">
		body{
            padding:0;
            margin:0;
            background-image:url('clips.jpg');
...
<b>
	...
	<!--StudentID Input-->
	               <div class="loginbox">
	                    <img src="studentavatar.png" class="avatar">
	                    <h1>Student Login</h1>
	                    <h4>Login Using Your Credentials</h4>
	                    <form action="com.myproject.onlineexam.controller.ValidateStudent" method="post">
                        <p>STUDENT ID<p>
                       <input type="text" name="studentId" class="form-input">
